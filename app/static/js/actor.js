// d3 4.0版本
$(function(){
  $.get('/actor/graph', function(result) {
    ...
    root.edges.forEach(function(e) {
        ...
        console.log("e");
        console.log(e);
        var sourceNode = root.nodes.filter(function(n) { console.log("n");console.log(n);console.log("e.source");console.log(e.source);return n.id === e.source; })[0],
    ...
    var svg = d3.select("#actor_content").append("svg")
                                .attr("width",width)
                                .attr("height",height);
